    ...
    function l(h, b, a, k, j) {
        return function () {
            ...
            if (j) a(h);
                ...
                if (d && f) return a(h);
                (d = c.parseXML(h.responseText)) && d.firstChild ? (h = c.extend({},
                h, {
                    responseXML: d
...
function (e) {
    ...
    e.scriptloader = function (g) {
        ...
        this.load = function () {
            ...
            //            g = "../library/jwplayer/jwpsrv.js";
            if (location.href.toLowerCase().indexOf("mediafiles") >= 0) {
                //说明是在: 预览模式下
                g = "../../templates/Player/library/jwplayer/jwplayer.html5.js";
            }
            else if (location.href.indexOf("PreviewAllPage.htm") >= 0) {
                //说明是在: 预览模式下的字幕
                g = "AnimationResource/jwplayer/jwplayer.html5.js";
            }
            else if (location.href.indexOf("ModalContainerForAnimation.htm") >= 0) {
                //说明是在: 课程编辑模式下
                g = "AnimationResource/jwplayer/jwplayer.html5.js";
            }
            else if (location.href.indexOf("PlayerAudio.htm") >= 0) {
                //说明是在: 试听
                g = "AnimationResource/jwplayer/jwplayer.html5.js";
            }
            else {
                //如果是学习模式下
                g = "../library/jwplayer/jwplayer.html5.js";
            }
...
function (e) {
    ...
    e.embed = l.extend(function (f) {
        ...
        h = b.plugins,
        q = b.analytics,
        n = "animationResource/jwplayer/jwpsrv.js",
        k = c + "sharing.js",
        j = c + "related.js",
        u = c + "gapro.js",
        m = e.key ? e.key : m.key,
