...
CKEDITOR.plugins.add('AreaBGColor', {
    requires: 'panelbutton,floatpanel',
    // jscs:disable maximumLineLength
    lang: 'af,ar,bg,bn,bs,ca,cs,cy,da,de,el,en,en-au,en-ca,en-gb,eo,es,et,eu,fa,fi,fo,fr,fr-ca,gl,gu,he,hi,hr,hu,id,is,it,ja,ka,km,ko,ku,lt,lv,mk,mn,ms,nb,nl,no,pl,pt,pt-br,ro,ru,si,sk,sl,sq,sr,sr-latn,sv,th,tr,tt,ug,uk,vi,zh,zh-cn', // %REMOVE_LINE_CORE%
    // jscs:enable maximumLineLength
    icons: 'AreaBGColor', // %REMOVE_LINE_CORE%
    init: function (editor) {
        var config = editor.config,
			lang = editor.lang.colorbutton;

        if (!CKEDITOR.env.hc) {
            addButton('AreaBGColor', 'back', lang.bgColorTitle, 30);
        }

        function addButton(name, type, title, order) {
            colorBoxId = CKEDITOR.tools.getNextId() + '_EditorAreaColorBox';
        ...
        function renderColors(panel, type, colorBoxId) {
            ...
            var clickFn = CKEDITOR.tools.addFunction(function (color, type) {
                ...
                // Clean up any conflicting style within the range. inherit

                //                $(window.frames[0].document).find(".cke_editable").css("background-color", "inherit");
                $("#CommonModal .cke_wysiwyg_frame").contents().find(".cke_editable").css("background-color", "inherit");
                ...
                if (color) {
                    ...
                    //					$(window.frames[0].document).find(".cke_editable").css("background-color", color);
					$("#CommonModal .cke_wysiwyg_frame").contents().find(".cke_editable").css("background-color", color);
                }
