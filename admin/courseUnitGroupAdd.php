...
<div id="content" class="maxcontent">
	...
	<div id="content_with_menu">
		<div id="container">
			<div class="info">添加/编辑课程单元组</div>
			<div class="list_courseUnit">
			<br>
			<br>
			<br>
			<br>
			<form action="save.php?type=31" method="post" onsubmit="return check();">
			课程单元组名称：<input style="width:250px;" type="text" name="title" id="title" value="<?php echo isset($_GET["title"])?$_GET["title"]:"";?>"><input type="hidden" name="id" value="<?php echo isset($_GET["id"])?$_GET["id"]:0;?>"> <button type="submit" >确定</button>
			</form>
