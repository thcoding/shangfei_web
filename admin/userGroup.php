...
<div id="content" class="maxcontent">
	...
	<div id="content_with_menu">
		<div id="container">
			<div class="info">用户组 &nbsp; <a href="userGroupAdd.php"><img src="../img/add_usergroup.png" width="30" title="创建用户组" alt="创建用户组"></a></div>
			...
			<?php
				...
				while($arr = $mysql->fetch_array($res)){
					echo "<li><span><a href='userGroupAdd.php?id=$arr[id]&title=$arr[title]'><img src='../img/edit.png'></a> <a href='delete.php?type=51&id=$arr[id]'><img src='../img/delete.png'></a></span><a href='user_for_group.php?id=$arr[id]&title=$arr[title]'>".$arr["title"]."</a></li>";
				}
			?>
			</ul>
			</div>
