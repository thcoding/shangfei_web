...
<script src="./scorm/scorm_api.js" type="text/javascript" language="javascript"></script>
...
<div id="content" class="maxcontent">
	...
	<div id="content_with_menu">
		<div id="container">
			<iframe width="740" align="center" id="showDetail" name="showDetail" onload="Javascript:SetWinHeight(this)" frameborder="0" scrolling=""></iframe>
		</div>
	</div>
