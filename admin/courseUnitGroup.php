...
<div id="content" class="maxcontent">
	...
	<div id="content_with_menu">
		<div id="container">
			<div class="info">课程单元组列表 &nbsp; <a href="courseUnitGroupAdd.php"><img src="../img/add_courseunitgroup.png" width="30" title="创建课程单元组" alt="创建课程单元组"></a></div>
			...
			<?php
				...
				while($arr = $mysql->fetch_array($res)){
					...
					echo "<li><span><a href='courseUnitGroupAdd.php?id=$arr[id]&title=$arr[title]'><img src='../img/edit.png'></a> <a href='delete.php?type=31&id=$arr[id]'><img src='../img/delete.png'></a></span><a href='courseUnit_for_group.php?id=$arr[id]&title=$arr[title]'>".$arr["title"]."</a> <span title='创建者'>【".$userinfo["realname"]."】</span></li>";
				}
			?>
			</ul>
			</div>
