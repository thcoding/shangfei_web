...
<div id="main" style="width:1000px"> <!-- start of #main wrapper for #content and #menu divs -->
...
<div id="learningPathMain" style="margin-top:5px;margin-bottom:5px;background-color:#666666; ">
	...
	<div id="learningPathRightZone" style="margin:auto;height:100%;background-color:#666666;">
		<?php
