...
$interbreadcrumb[]= array ("url"=>"./lp_list.php", "name"=> "Doc");
...
//header("Location: ".urldecode($src)); //annotated for multi-reload page and thus incur the cannot change page bug by xjh