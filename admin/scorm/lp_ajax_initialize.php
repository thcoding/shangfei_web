...
function initialize_item($lp_id,$user_id,$view_id,$next_item)
{
    ...
    */
    ...
    //$mylesson_location = api_is_anonymous() ? '' : $mylpi->get_lesson_location();
    ...
    //init time before session. Scorm session time will be added to this time to store total time in db
    $mylpi->time_before_session = intval($mylpi->get_db_time());
